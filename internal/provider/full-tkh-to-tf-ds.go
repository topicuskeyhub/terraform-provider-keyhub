...
func tkhToTFObjectDSROItemCountRO(recurse bool, tkh keyhubmodel.ItemCountable) (types.Object, diag.Diagnostics) {
	var diags diag.Diagnostics
	var attrs map[string]attr.Type
	if recurse {
		attrs = itemCountAttrTypesDSRORecurse
	} else {
		attrs = itemCountAttrTypesDSRO
	}
	if tkh == nil {
		return types.ObjectNull(attrs), diags
	}
...
func tkhToTFObjectDSAuthAccount_additionalObjects(recurse bool, tkh keyhubmodel.AuthAccount_additionalObjectsable) (types.Object, diag.Diagnostics) {
	...
	{
		val, d := tkhToTFObjectDSROAuthEffectiveAccountPermissionsRO(recurse, tkh.GetEffectivePermissions())
		diags.Append(d...)
		obj["effective_permissions"] = val
	}
	{
	...
	{
		val, d := tkhToTFObjectDSROItemCountRO(recurse, tkh.GetTotalGroupCount())
		diags.Append(d...)
		obj["total_group_count"] = val
	}
	{
...
func tkhToTFObjectDSROAuthEffectiveAccountPermissionsRO(recurse bool, tkh keyhubmodel.AuthEffectiveAccountPermissionsable) (types.Object, diag.Diagnostics) {
	var diags diag.Diagnostics
	var attrs map[string]attr.Type
	if recurse {
		attrs = authEffectiveAccountPermissionsAttrTypesDSRORecurse
	} else {
		attrs = authEffectiveAccountPermissionsAttrTypesDSRO
	}
	if tkh == nil {
		return types.ObjectNull(attrs), diags
	}
	...
	obj := make(map[string]attr.Value)
	obj["decline_reset_requests_allowed"] = types.BoolPointerValue(tkh.GetDeclineResetRequestsAllowed())
	obj["disable_account_allowed"] = types.BoolPointerValue(tkh.GetDisableAccountAllowed())
	obj["disable_two_factor_allowed"] = types.BoolPointerValue(tkh.GetDisableTwoFactorAllowed())
	obj["enable_account_allowed"] = types.BoolPointerValue(tkh.GetEnableAccountAllowed())
	obj["update_can_request_groups_allowed"] = types.BoolPointerValue(tkh.GetUpdateCanRequestGroupsAllowed())
	obj["update_license_role_allowed"] = types.BoolPointerValue(tkh.GetUpdateLicenseRoleAllowed())
	obj["update_reregistration_allowed"] = types.BoolPointerValue(tkh.GetUpdateReregistrationAllowed())
	obj["view_full_audit_log"] = types.BoolPointerValue(tkh.GetViewFullAuditLog())
	obj["view_groups_and_profiles"] = types.BoolPointerValue(tkh.GetViewGroupsAndProfiles())
...
func tkhToTFObjectDSROGroupGroupPrimerLinkableWrapperWithCountRO(recurse bool, tkh keyhubmodel.GroupGroupPrimerLinkableWrapperWithCountable) (types.Object, diag.Diagnostics) {
	...
	var attrs map[string]attr.Type
	if recurse {
		attrs = groupGroupPrimerLinkableWrapperWithCountAttrTypesDSRORecurse
	} else {
		attrs = groupGroupPrimerLinkableWrapperWithCountAttrTypesDSRO
	}
	if tkh == nil {
		return types.ObjectNull(attrs), diags
	}
...
func tkhToTFObjectDSIdentityAccountAttributeDefinition(recurse bool, tkh keyhubmodel.IdentityAccountAttributeDefinitionable) (types.Object, diag.Diagnostics) {
	...
	obj["name"] = types.StringPointerValue(tkh.GetName())
	{
		...
		val, d := sliceToTFList(elemType, tkh.GetProperties(), func(tkh keyhubmodel.IdentityAccountAttributeDefinitionPropertyable, diags *diag.Diagnostics) attr.Value {
			val, d := tkhToTFObjectDSIdentityAccountAttributeDefinitionProperty(false, tkh)
			diags.Append(d...)
			return val
		})
		diags.Append(d...)
...
func tkhToTFObjectDSROIdentityAccountAttributeDefinitionRO(recurse bool, tkh keyhubmodel.IdentityAccountAttributeDefinitionable) (types.Object, diag.Diagnostics) {
	...
	obj["name"] = types.StringPointerValue(tkh.GetName())
	{
		elemType := attrs["properties"].(types.ListType).ElemType
		val, d := sliceToTFList(elemType, tkh.GetProperties(), func(tkh keyhubmodel.IdentityAccountAttributeDefinitionPropertyable, diags *diag.Diagnostics) attr.Value {
			val, d := tkhToTFObjectDSROIdentityAccountAttributeDefinitionPropertyRO(false, tkh)
			diags.Append(d...)
			return val
		})
		diags.Append(d...)
...
func tkhToTFObjectDSIdentityAccountAttributeDefinitionProperty(recurse bool, tkh keyhubmodel.IdentityAccountAttributeDefinitionPropertyable) (types.Object, diag.Diagnostics) {
	var diags diag.Diagnostics
	var attrs map[string]attr.Type
	if recurse {
		attrs = identityAccountAttributeDefinitionPropertyAttrTypesDSRecurse
	} else {
		attrs = identityAccountAttributeDefinitionPropertyAttrTypesDS
	}
	if tkh == nil {
		return types.ObjectNull(attrs), diags
	}
...
func tkhToTFObjectDSROIdentityAccountAttributeDefinitionPropertyRO(recurse bool, tkh keyhubmodel.IdentityAccountAttributeDefinitionPropertyable) (types.Object, diag.Diagnostics) {
	var diags diag.Diagnostics
	var attrs map[string]attr.Type
	if recurse {
		attrs = identityAccountAttributeDefinitionPropertyAttrTypesDSRORecurse
	} else {
		attrs = identityAccountAttributeDefinitionPropertyAttrTypesDSRO
	}
	if tkh == nil {
		return types.ObjectNull(attrs), diags
	}
...
func tkhToTFObjectDSROWebhookWebhookRO(recurse bool, tkh keyhubmodel.WebhookWebhookable) (types.Object, diag.Diagnostics) {
	...
	obj["name"] = types.StringPointerValue(tkh.GetName())
	{
		val, d := tkhToTFObjectDSROServiceaccountServiceAccountPrimerRO(false, tkh.GetServiceAccount())
		diags.Append(d...)
		obj["service_account"] = val
	}
	{
