...
func tfObjectToTKHDSGroupAccountGroupsWrapper(ctx context.Context, recurse bool, objVal types.Object) (keyhubmodel.GroupAccountGroupsWrapperable, diag.Diagnostics) {
	...
	tkh.SetTotalAccountGroupCount(objAttrs["total_account_group_count"].(basetypes.Int64Value).ValueInt64Pointer())
	return tkh, diags
}
...
func tfObjectToTKHDSProvisioningGroupOnSystem_additionalObjects(ctx context.Context, recurse bool, objVal types.Object) (keyhubmodel.ProvisioningGroupOnSystem_additionalObjectsable, diag.Diagnostics) {
	...
	{
		val, d := tfObjectToTKHDSProfileAccessProfileProvisioningLinkableWrapper(ctx, recurse, toItemsList(ctx, objAttrs["access_profile_provisioning"]))
		diags.Append(d...)
