...
func tkhToTFObjectRSGroupGroupPrimerLinkableWrapperWithCount(recurse bool, tkh keyhubmodel.GroupGroupPrimerLinkableWrapperWithCountable) (types.Object, diag.Diagnostics) {
	var diags diag.Diagnostics
	var attrs map[string]attr.Type
	if recurse {
...
func tkhToTFObjectRSROGroupGroupPrimerLinkableWrapperWithCountRO(recurse bool, tkh keyhubmodel.GroupGroupPrimerLinkableWrapperWithCountable) (types.Object, diag.Diagnostics) {
	var diags diag.Diagnostics
	var attrs map[string]attr.Type
	if recurse {
...
func tkhToTFObjectRSGroupGroup_additionalObjects(recurse bool, tkh keyhubmodel.GroupGroup_additionalObjectsable) (types.Object, diag.Diagnostics) {
	...
	{
		val, d := tkhToTFObjectRSGroupGroupPrimerLinkableWrapperWithCount(recurse, tkh.GetExcludedGroups())
		diags.Append(d...)
		obj["excluded_groups_uuid"] = getItemsAttr(val, attrs["excluded_groups_uuid"])
	}
	{
...
func tkhToTFObjectRSROGroupGroup_additionalObjectsRO(recurse bool, tkh keyhubmodel.GroupGroup_additionalObjectsable) (types.Object, diag.Diagnostics) {
	...
	{
		val, d := tkhToTFObjectRSROGroupGroupPrimerLinkableWrapperWithCountRO(recurse, tkh.GetExcludedGroups())
		diags.Append(d...)
...
func tkhToTFObjectRSROLaunchpadManualLaunchpadTileRO(recurse bool, tkh keyhubmodel.LaunchpadManualLaunchpadTileable) (types.Object, diag.Diagnostics) {
	...
	obj := make(map[string]attr.Value)
	{
		val, d := tkhToTFObjectRSROGroupGroupPrimerRO(recurse, tkh.GetGroup())
		diags.Append(d...)
		obj["group"] = val
	}
	obj["title"] = types.StringPointerValue(tkh.GetTitle())
...
func tkhToTFObjectRSROLaunchpadSsoApplicationLaunchpadTileRO(recurse bool, tkh keyhubmodel.LaunchpadSsoApplicationLaunchpadTileable) (types.Object, diag.Diagnostics) {
	...
	obj := make(map[string]attr.Value)
	{
		val, d := tkhToTFObjectRSROClientClientApplicationPrimerRO(recurse, tkh.GetApplication())
		diags.Append(d...)
		obj["application"] = val
	}
	obj["uri"] = types.StringPointerValue(tkh.GetUri())
...
func tkhToTFObjectRSROLaunchpadVaultRecordLaunchpadTileRO(recurse bool, tkh keyhubmodel.LaunchpadVaultRecordLaunchpadTileable) (types.Object, diag.Diagnostics) {
	...
	obj := make(map[string]attr.Value)
	{
		val, d := tkhToTFObjectRSROVaultVaultRecordPrimerRO(recurse, tkh.GetVaultRecord())
		diags.Append(d...)
...
func tkhToTFObjectRSROProvisioningProvisionedAzureSyncLDAPDirectoryRO(recurse bool, tkh keyhubmodel.ProvisioningProvisionedAzureSyncLDAPDirectoryable) (types.Object, diag.Diagnostics) {
	...
	{
		val, d := tkhToTFObjectRSRODirectoryAccountDirectoryPrimerRO(recurse, tkh.GetOidcDirectory())
		diags.Append(d...)
		obj["oidc_directory"] = val
	}
	obj["tenant"] = types.StringPointerValue(tkh.GetTenant())
...
func tkhToTFObjectRSROProvisioningProvisionedSystemRO(recurse bool, tkh keyhubmodel.ProvisioningProvisionedSystemable) (types.Object, diag.Diagnostics) {
	...
	obj["active_status"] = stringerToTF(tkh.GetActiveStatus())
